...
slug: vps-traefik-log-dashboard
type: service
status: active
tags: ["homelab", "vps", "service", "traefik-log-dashboard"]
aliases: ["traefik-log-dashboard (agent + UI)", "traefik-log-dashboard"]
entities:
  primary: vps-traefik-log-dashboard
  mentions: []
...
- Access the UI via `https://traefik-logs.dennisb.xyz` (Traefik-fronted,
