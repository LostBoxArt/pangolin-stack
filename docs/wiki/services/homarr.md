---
title: "homarr"
slug: cloudnode-homarr
type: service
status: active
tags: ["homelab", "cloudnode", "service", "homarr"]
aliases: ["homarr"]
entities:
  primary: cloudnode-homarr
  mentions: []
...
```22:46:stacks/dashboard/docker-compose.yml
  homarr:
    ...
    environment:
      ...
      - TZ=Asia/Jerusalem
    extra_hosts:
      - "torrent.example.com:192.168.1.10"
    labels:
      - "traefik.enable=true"
      - "traefik.http.routers.homarr.rule=Host(`home.example.com`)"
