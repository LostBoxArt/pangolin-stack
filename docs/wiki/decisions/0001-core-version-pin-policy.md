...
entities:
  ...
  mentions: []
related: ["../system-overview.md", "../services/traefik.md", "../services-nasus/traefik.md"]
...
- Pin only the VPS side and let NASUS float independently.
