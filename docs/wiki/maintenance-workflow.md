...
- service pages under `docs/wiki/services/` and `docs/wiki/services-nasus/`
...
3. the relevant dated review under `docs/wiki/`
   - VPS work: `docs/wiki/compose-review-2026-04-17.md`
   - NASUS work: `docs/wiki/nasus-review-2026-04-17.md`
4. relevant `docs/wiki/services/<service>.md` or
   `docs/wiki/services-nasus/<service>.md`
...
6. for NASUS, update the live NASUS file, `host-configs/nasus/<service>/docker-compose.yml`, and the matching `services-nasus` page together
...
- README references to NASUS pages that do not exist, or service pages that exist but are missing from the TOC
...
- refresh NASUS indexes and service-page lists after new `services-nasus/` pages land
