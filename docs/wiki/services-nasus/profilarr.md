---
title: "profilarr"
slug: nasus-profilarr
type: service
status: active
tags: ["homelab", "nasus", "service", "profilarr"]
aliases: ["profilarr"]
entities:
  primary: nasus-profilarr
  mentions: []
...
services:
  profilarr:
    ...
    labels:
      - "traefik.http.routers.profilarr.rule=Host(`profilarr.dennisb.xyz`)"
