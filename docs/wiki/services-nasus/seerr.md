...
type: service
status: active
tags: ["homelab", "nasus", "service", "seerr"]
aliases: ["seerr"]
entities:
  primary: nasus-seerr
  mentions: []
...
#        ipv4_address: 172.18.0.11
    labels:
      - "traefik.http.routers.seerr.rule=Host(`request.dennisb.xyz`)"
...
As with every other NASUS service. Pin after confirming F-N-SEERR-1.
...
This is actually one of the better-hardened compose files on NASUS:
