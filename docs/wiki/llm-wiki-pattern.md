...
Good next steps:
- add missing HomeNode pages only when source-controlled or live evidence is
  available
...
Bad next steps:
- invent missing HomeNode documentation from memory
...
Applied here:
- CloudNode pages live under `docs/wiki/services/`
- HomeNode pages live under `docs/wiki/services-homenode/`
