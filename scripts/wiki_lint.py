...
SERVICE_DIRS = [WIKI / 'services', WIKI / 'services-homenode']
CANONICAL_PATHS = [
    WIKI / 'services', WIKI / 'services-homenode', WIKI / 'hosts', WIKI / 'networks',
    ...
    WIKI / 'homenode-review-2026-04-17.md', WIKI / 'llm-wiki-pattern.md',
