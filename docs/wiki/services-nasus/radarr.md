...
type: service
status: active
tags: ["homelab", "nasus", "service", "radarr"]
aliases: ["radarr"]
entities:
  primary: nasus-radarr
  mentions: []
related: ["./README.md", "./nasus-review-2026-04-17.md", "./system-overview.md"]
sources: ["/volume1/docker/config/radarr/docker-compose.yml", "host-configs/nasus/radarr/docker-compose.yml"]
confidence: high
...
- **Tracked copy**: `host-configs/nasus/radarr/docker-compose.yml` ✓
- **Port (internal)**: `7878`
- **Router**: `radarr.dennisb.xyz`
- **Volumes**:
...
services:
  radarr:
    ...
    labels:
      - "traefik.http.routers.radarr.rule=Host(`radarr.dennisb.xyz`)"
