---
title: "cleanuparr"
slug: nasus-cleanuparr
type: service
status: active
tags: ["homelab", "nasus", "service", "cleanuparr"]
aliases: ["cleanuparr"]
entities:
  primary: nasus-cleanuparr
  mentions: []
...
services:
  cleanuparr:
    ...
    labels:
      - "traefik.http.routers.cleanuparr.rule=Host(`cleanuparr.dennisb.xyz`)"
