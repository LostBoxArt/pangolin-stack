...
type: service
status: active
tags: ["homelab", "nasus", "service", "sonarr"]
aliases: ["sonarr"]
entities:
  primary: nasus-sonarr
  mentions: []
related: ["./README.md", "./nasus-review-2026-04-17.md", "./system-overview.md"]
sources: ["/volume1/docker/config/sonarr/docker-compose.yml", "host-configs/nasus/sonarr/docker-compose.yml"]
confidence: high
...
- **Tracked copy**: `host-configs/nasus/sonarr/docker-compose.yml` ✓
- **Port (internal)**: `8989`
- **Router**: `sonarr.dennisb.xyz` (Traefik cert resolver `cloudflare`)
- **Volumes**:
...
services:
  sonarr:
    ...
    labels:
      - "traefik.enable=true"
      - "traefik.http.routers.sonarr.rule=Host(`sonarr.dennisb.xyz`)"
