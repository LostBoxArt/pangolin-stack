...
type: service
status: active
tags: ["homelab", "nasus", "service", "bazarr"]
aliases: ["bazarr"]
entities:
  primary: nasus-bazarr
  mentions: []
related: ["./README.md", "./nasus-review-2026-04-17.md", "./system-overview.md"]
sources: ["/volume1/docker/config/bazarr/docker-compose.yml", "host-configs/nasus/bazarr/docker-compose.yml"]
confidence: high
...
- **Tracked copy**: `host-configs/nasus/bazarr/docker-compose.yml` ✓
- **Port (internal)**: `6767`
- **Router**: `bazarr.dennisb.xyz`
- **Volumes**:
...
services:
  bazarr:
    ...
    labels:
      - "traefik.http.routers.bazarr.rule=Host(`bazarr.dennisb.xyz`)"
