...
**Phase 0 — today.** `docs/wiki/` exists with `README.md`, `llm-wiki-pattern.md`, `llms.txt`, `llms-full.txt`, `log.md`, `maintenance-workflow.md`, `system-overview.md`, plus `services/` and `services-nasus/`. Good foundation.
